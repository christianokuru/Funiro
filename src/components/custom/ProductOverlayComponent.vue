<template>
    <div
      class="absolute inset-0 bg-neutral-700 bg-opacity-70 opacity-0 group-hover:opacity-100 transition-opacity"
    >
      <div class="absolute top-2/4 left-2/4 -translate-x-1/2 -translate-y-1/2">
        <div class="flex flex-col gap-6 items-center">
          <button
            class="h-12 font-semibold text-yellow-600 bg-white w-[202px] hover:bg-gray-50 transition-colors"
          >
            Add to cart
          </button>
          <div class="flex gap-5 items-center text-white">
            <button
              class="flex gap-0.5 items-center hover:text-gray-200 transition-colors"
            >
              <svg
                width="16"
                height="16"
